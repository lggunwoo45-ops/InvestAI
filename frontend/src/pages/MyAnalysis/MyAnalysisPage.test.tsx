...
describe('MyAnalysisPage', () => {
  ...
  it('starts empty, selects an instrument, and switches the global detail level', async () => {
    ...
    expect(screen.getByRole('region', { name: 'Current action status' }).textContent).toContain('Decision pending')
    expect(screen.getByText('Signal clarity: Low clarity')).toBeTruthy()
