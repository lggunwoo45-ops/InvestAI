...
const estimates: Readonly<Record<AiRequestType, AiUsageEstimate>> = {
  ...
  candidateReport: { requestType: 'candidateReport', label: 'Candidate report', estimatedCredits: 3, estimatedInputSize: 'Candidate and linked-news evidence', estimatedOutputSize: 'Structured research report', recommendedTier: 'basic', cacheable: true, notes: 'Future paid AI feature; no report request is connected.', unit: 'report' },
