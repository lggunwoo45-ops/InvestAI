...
const copy = {
  ...
  ko: {
    ...
    guideItems: [['판단 보류', '데이터 신뢰도가 아직 충분하지 않습니다.'], ['대기 / 조건 확인 중', '추가 조건 확인이 필요합니다.'], ['관심 구간', '조건이 불완전한 동안 계속 살펴볼 상태입니다.'], ['조건부 접근 가능', '일부 조건은 있지만 추가 확인이 필요합니다.'], ['변동 확대 주의', '최근 움직임이 이미 큰 상태입니다.'], ['급락 반등 접근 주의', '급락 후 반등은 추가 근거가 필요합니다.']],
  },
} as const
